...
Message.create!([
  {
    connection_id: 4, 
    user_id: 5, 
    body: "Hey Miley, can I have yo number?", 
    read: false
  },
  {
    connection_id: 1, 
    user_id: 2, 
    body: "Greetings lord, I am ready for the knowledge", 
    read: false
  },
  {
    connection_id: 2, 
    user_id: 3, 
    body: "Greetings my lord, I am ready for my walk.", 
    read: false
  },
  {
    connection_id: 1, 
    user_id: 5, 
    body: "You trynna code?", 
    read: false
  },
  {
    connection_id: 4, 
    user_id: 3, 
    body: "Hey bud you wanna treat?", 
    read: false
  },
])